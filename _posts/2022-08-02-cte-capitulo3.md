...
<div id="explicacion3" style="display: none">
  ...
  <br>
  <br>
  En caso de que el balance del contrato sea mayor al balance inicial (1 ether), la variable <i>withdraw</i> pasaría a ser un valor extremadamente elevado, el chequeo podría ser salteado y procederíamos a enviarnos todo el balance del contrato a nuestra address. El problema que nos encontramos, es que el contrato no tiene ninguna función para recibir ether (fallback o receive). Entonces: ¿Habrá alguna forma de forzar el envío de ether? ¡La respuesta es sí!
  <br>
  <br>
